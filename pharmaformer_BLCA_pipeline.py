...
if PHASE == '':
    ...
    print('='*60)
    print('PharmaTFormer BLCA Pipeline')
    print('='*60)
...
MODEL_PATH = os.path.join(output_dir, 'ensemble_model_BLCA.pth')
...
def run_pretrain():
    ...
    expr = pd.read_csv(f'{dataDir}/ccle/ccle_rnaseq_BLCA.csv', index_col=0)
...
def run_finetune():
    ...
    info = {
        'BLCA': {'gpath': f'{dataDir}/organoid/BLCA/BLCA_organoid_TPM.csv', 'dpath': f'{dataDir}/organoid/BLCA/BLCA_drug_response.csv',
                 'tpath': f'{dataDir}/tcga_reproduce/TCGA-BLCA-gene-adjust.csv', 'drugs': ['Gemcitabine', 'Cisplatin']}
    }
